...
import { Body } from "../../components/location/body"; // Adjusted path
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen p-8 gap-16 font-[family-name:var(--font-geist-sans)]"> {/* Keep Navbar and Footer unstyled */}
